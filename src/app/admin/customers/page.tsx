            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-gray-900 text-lg">All Registered Customers ({customers.length})</h3>
                    </div>
                    ...
                    <table className="w-full text-left border-collapse min-w-[1000px]">
                        <thead>
                            <tr className="bg-gray-50/50 text-gray-500 text-sm font-semibold border-b border-gray-100">
                                <th className="px-6 py-4 rounded-tl-xl whitespace-nowrap">Customer Info</th>
                                <th className="px-6 py-4 whitespace-nowrap">Contact</th>
                                <th className="px-6 py-4 whitespace-nowrap">Delivery Address</th>
                                <th className="px-6 py-4 whitespace-nowrap text-center">Orders</th>
                                <th className="px-6 py-4 rounded-tr-xl whitespace-nowrap text-right">Total Spent</th>
                            </tr>
                        </thead>
