                ...
                <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Revenue tracking for the last 7 days</p>
                        </div>
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs text-gray-500 uppercase bg-gray-50/50">
                            <tr>
                                ...
                                <th className="px-6 py-4 font-bold tracking-wider">Current Value</th>
                                <th className="px-6 py-4 font-bold tracking-wider">Status</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-50">
                            <tr>
                                <td className="px-6 py-4 text-gray-900 font-medium">Oct 24, 2023</td>
                                <td className="px-6 py-4 text-gray-600">Active Subscriptions</td>
                            ...
                            <tr>
                                <td className="px-6 py-4 text-gray-900 font-medium">Oct 23, 2023</td>
                                <td className="px-6 py-4 text-gray-600">Delivery Efficiency</td>
