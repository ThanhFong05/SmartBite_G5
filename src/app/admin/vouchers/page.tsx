    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900">Voucher Management</h1>
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-[600px] overflow-y-auto max-h-[90vh]">
                        <DialogHeader>
                            <DialogTitle>{editingVoucherId ? "Edit Voucher" : "Create New Voucher"}</DialogTitle>
                            <DialogDescription>
                                Set up the rules, limits, and values for this promotional code.
                            </DialogDescription>
                        </DialogHeader>
                        <form onSubmit={handleSubmit} className="grid gap-6 py-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    <Label htmlFor="vouchercode" className="font-semibold text-gray-700">Voucher Code</Label>
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="vouchertype" className="font-semibold text-gray-700">Voucher Type</Label>
                                    <select
                                        id="vouchertype"
                                        name="vouchertype"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    <Label htmlFor="discountvalue" className="font-semibold text-gray-700">Discount Value (VNĐ)</Label>
                                    <div className="relative">
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="minordervalue" className="font-semibold text-gray-700">Min Order Value (VNĐ)</Label>
                                    <div className="relative">
                                        <Banknote className="absolute left-3 top-2.5 h-4 w-4 text-gray-400" />
                                        <Input
                                            id="minordervalue"
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="maxusage" className="font-semibold text-gray-700">Usage Limit (Lượt sử dụng)</Label>
                                <Input
                                    id="maxusage"
                                    name="maxusage"
                                    type="number"
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="isactive" className="font-semibold text-gray-700">Status</Label>
                                <select
                                    id="isactive"
                                    name="isactive"
                                    className="flex h-10 w-full rounded-md border border-input bg-gray-50 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                                ...
                                >
                                    ...
                                    <option value="0">Inactive (Vô hiệu hóa)</option>
                                </select>
                            </div>
                            ...
                            <DialogFooter className="mt-6 pt-4 border-t border-gray-100">
                                ...
                                <Button type="submit" disabled={isSubmitting} className="bg-orange-500 hover:bg-orange-600 text-white">
                                    {isSubmitting ? "Saving..." : (editingVoucherId ? "Update Voucher" : "Create Voucher")}
                                </Button>
                            </DialogFooter>
                        </form>
                    </DialogContent>
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="relative w-64 hidden md:block">
                            ...
                            <Input placeholder="Search code..." className="pl-8 bg-gray-50 border-gray-200 focus-visible:ring-orange-500" />
                        </div>
                    </div>
                </CardHeader>
                <CardContent>
