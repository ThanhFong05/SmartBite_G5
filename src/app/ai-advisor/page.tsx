...
export default function AIAdvisorPage() {
    ...
    const handleRegenerate = async (index: number) => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : "Sorry, I encountered an error regenerating. Please try again.";
            setMessages((prev) => [...prev, { role: "assistant", content: errorMessage }]);
        } finally {
            setIsLoading(false);
        }
                ...
                <main className="flex-1 flex overflow-hidden">
                    ...
                    <aside className="w-64 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 hidden md:flex flex-col p-4 transition-colors">
                        <div className="flex gap-2 mb-6 shrink-0">
                            ...
                            <Button size="icon" variant="outline" onClick={() => setIsDarkMode(!isDarkMode)} className="shrink-0 dark:border-gray-700 dark:text-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700">
                    ...
                    <div className="flex-1 flex flex-col bg-white md:bg-[#F9FAFB] dark:bg-gray-950 md:dark:bg-gray-900 transition-colors">
                        ...
                        <div className="md:hidden p-4 border-b dark:border-gray-800 bg-white dark:bg-gray-900 flex items-center justify-between transition-colors">
                            <span className="font-bold text-gray-700 dark:text-gray-100">AI Nutrition Assistant</span>
                            <div className="flex items-center gap-1">
                                <Button size="icon" variant="ghost" onClick={() => setIsDarkMode(!isDarkMode)} className="dark:text-gray-200">
                                    ...
                                    <div key={index} className={`flex gap-4 animate-in fade-in slide-in-from-bottom-2 duration-300 ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                                            ...
                                            {msg.role === "assistant" && (
                                                <div className="flex items-center gap-2 mt-4 pt-2 border-t border-gray-50 dark:border-gray-700/50">
                                                    <button
                                                        ...
                                                        <span className="inline-block transition-transform duration-300 origin-left group-hover:scale-105 group-hover:translate-x-0.5 group-hover:font-medium">Helpful</span>
                                                    </button>
                                                    <button
                                                        ...
                                                        <span className="inline-block transition-transform duration-300 origin-left group-hover:scale-105 group-hover:translate-x-0.5 group-hover:font-medium">Not helpful</span>
                                                    </button>
                                                    <button
                                                        ...
                                                        <span className="inline-block transition-transform duration-300 origin-left group-hover:scale-105 group-hover:translate-x-0.5 group-hover:font-medium">Regenerate</span>
                                                    </button>
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        {msg.role === "user" && (
                                            <Avatar className="w-8 h-8 mt-1 border-2 border-white dark:border-transparent shadow-sm">
                                                ...
                                                <AvatarFallback className="bg-blue-100 text-blue-600 text-xs font-bold">Me</AvatarFallback>
                                            </Avatar>
                                        )}
                                    </div>
                                ))}
                        ...
                        <div className="p-4 md:p-6 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 transition-colors">
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="text-center mt-3">
                                    <p className="text-[11px] text-gray-500 dark:text-gray-400">SmartBite AI may display inaccurate info, please double check important nutrition facts.</p>
                                </div>
                            </div>
                        </div>
                    </div>
