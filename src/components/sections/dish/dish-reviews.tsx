        ...
        <div className="space-y-8">
            ...
            {reviews.length === 0 ? (
                <div className="bg-gray-50 rounded-3xl p-12 text-center border-2 border-dashed border-gray-100">
                    ...
                    <p className="text-gray-500 font-medium italic">No reviews yet for this dish. Be the first to rate it!</p>
                </div>
            ) : (
                <div className="grid gap-6">
                    {reviews.map((review) => (
                        <div key={review.reviewid} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-gray-900">
                                            {review.orders?.users?.fullname || "Verified Customer"}
                                        </h4>
                            ...
                            {review.comment && (
                                <p className="text-gray-600 text-sm leading-relaxed italic border-l-2 border-orange-200 pl-4 py-1">
                                    "{review.comment}"
                                </p>
                            )}
                        </div>
